...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    private float[] mHeadPosition = new float[]{0.0f, 0.0f, 0.0f};

    private World world = new World();
    private WorldRunner runner = new WorldRunner();
    ...
    private boolean isLookingAtObject() {
        ...
        //Log.i(TAG, "");
        //Log.i(TAG, "");
        //Log.i(TAG, "Head View: " + mHeadView[0] +", " + mHeadView[1] + ", " + mHeadView[2]+ ", " + mHeadView[3]);
        //Log.i(TAG, "Head View: " + mHeadView[4] +", " + mHeadView[5] + ", " + mHeadView[6]+ ", " + mHeadView[7]);
        //Log.i(TAG, "Head View: " + mHeadView[8] +", " + mHeadView[9] + ", " + mHeadView[10]+ ", " + mHeadView[11]);
        //Log.i(TAG, "Head View: " + mHeadView[12] +", " + mHeadView[13] + ", " + mHeadView[14]+ ", " + mHeadView[15]);
